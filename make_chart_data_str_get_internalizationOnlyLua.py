...
#    'LuaHashMap51': 'Lua 5.1.5 (C API) table (via LuaHashMap)',
    ...
    'LuaHashMap52_internalized': 'Lua 5.2.1 (C API) table (via LuaHashMap) with internalization optimization',
    'LuaHashMap52_length_internalized': 'Lua 5.2.1 (C API) table (via LuaHashMap) with internalization and length',
}
...
#    'python_dict',
#    'perl_hash',
    'LuaHashMap52_internalized',	
    'LuaHashMap52_length_internalized',	
#    'ruby_hash',
#    'LuaHashMap51',
#    'LuaHashMapJIT',
]
